...
class TestUserService:
    ...
    def test_create_user_success(self, mock_dao_factory, sample_user_data):
        ...
        # Act
        result = self.user_service.create_user("Test User", "test@example.com", "password123", "user")
    ...
    def test_authenticate_user_failure(self, mock_dao_factory):
        ...
        # Act
        result = self.user_service.authenticate_user("wrong@example.com", "wrongpassword")
