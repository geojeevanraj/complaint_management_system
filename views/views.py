...
class ComplaintView(BaseView):
    ...
    def display_complaint_list(
        self, complaints: List[Dict[str, Any]], show_user: bool = False
    ):
    ...
    def display_complaint_details(
        self, complaint: Dict[str, Any], comments: List[Dict[str, Any]] = None
    ):
        ...
        if comments:
            ...
            for comment in comments:
                print(
                    f"[{comment['created_at']}] {comment['staff_name']}: {comment['comment']}"
                )
    ...
    def export_complaints_to_csv(
        self, complaints: List[Dict[str, Any]], filename: str = "complaints_export.csv"
    ):
